  ...
  return (
    <div>
        ...
        <div className={style.advantages}>
            ...
            <div className={style.advanItem}>
              <img src={ShopIcon} alt='photo' className={style.advanItem}/>
