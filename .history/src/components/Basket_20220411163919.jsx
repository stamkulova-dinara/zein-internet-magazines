...
const Basket = () => {
    ...
    const removeCountHandler = () => {
      ...
      const sub = () => {
        basketProduct.forEach((el) => total =+ el.price)
      }
  ...
  return (
    <div className={style.content}>
        ...
        <div className={style.order_amount}>
            ...
            <p className={style.order_product}>Количество товаров:<span className={style.order_length}>{total}шт</span></p>
            <p className={style.order_product}>Стоимость:<span className={style.order_length}> {total} рублей</span></p>
