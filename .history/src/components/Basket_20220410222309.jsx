...
const Basket = () => {
    ...
    const removeCountHandler = () => {
      ...
      const subTotal = basketProduct.map(el => el.price)
  ...
  return (
    <div className={style.content}>
        ...
        <div className={style.order_amount}>
            ...
            <p className={style.order_product}>Количество товаров:<span className={style.order_length}>{basketProduct.length} шт</span></p>
