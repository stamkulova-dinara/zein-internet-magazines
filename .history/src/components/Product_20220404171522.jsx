...
import bag from '../assets/icon/Icon.'
    ...
    <div>
       {
            ...
            <div className={style.product}>
              ...
              <Button variant="dark" id={style.add_bag_btn}><BsBag className={style.bag_icon}/> Добавить в корзину</Button>{' '}
              <Button variant="dark" id={style.like_btn}><FiHeart className={style.product_like_icon}/></Button>{' '}
              </div>
              </div>
              </div>
        }
